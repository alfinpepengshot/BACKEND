...
def index():
    ...
    return render_template('index_1123102125.html', books=books)
...
def tambah():
    ...
    return render_template('tambah_1123102125.html')
...
def edit(id):
    ...
    if request.method == 'POST':
        ...
        connection.close()
        return render_template('edit_1123102125.html', book=book)
